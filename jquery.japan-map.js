...
;(function($){
    ...
    $.fn.japanMap = function(options){
        ...
        options = $.extend({
            ...
            color               : "black",      // Default color, which used if no color is set in "areas" object.
    ...
    MapCanvas.prototype.getCenterOfPrefecture = function(prefecture){
        ...
        switch (prefecture.name){
            case "雪まつり"  : OFFSET.X = 10; OFFSET.Y = -5; break;
            case "牛たん"  : OFFSET.Y =  5; break;
            case "さくらんぼ"  : OFFSET.Y = -5; break;
            case "スーパーアリーナ"  : OFFSET.Y = -3; break;
            case "中華街": OFFSET.Y =  2; break;
            case "ディズニーランド"  : OFFSET.X =  7; break;
            case "兼六園"  : OFFSET.Y = -5; break;
            case "琵琶湖"  : OFFSET.Y =  5; break;
            case "八ツ橋"  : OFFSET.Y = -2; break;
            case "明石焼き"  : OFFSET.Y =  4; break;
            case "伊勢神宮"  : OFFSET.Y = -5; break;
            case "原爆ドーム"  : OFFSET.Y = -3; break;
            case "出雲大社"  : OFFSET.X = -5; break;
            case "かつお"  : OFFSET.X =  5; break;
            case "明太子"  : OFFSET.Y = -5; break;
            case "ちゃんぽん"  : OFFSET.Y =  5; break;
        }
